...
function load() {
 ...
 request.onload = function() {
  ...
  else newpost.innerHTML = '<a class="number" href="javascript:reply(\''+mail+'\')">'+n+'</a><span class="name">'+name+' ['+mail+']</span><div class="message">'+comment+'</div><span class="date"><a class="id" href="javascript:IdClick(\''+id+'\')">'+id+'</a>'+date+'</span><a href="/#'+bbs+'/'+thread+'/"><div class="subject">'+title+'</div></a>';
...
function Menu() {
document.getElementById('modal_text').innerHTML = '<a class="menulink" href="/test/TL.html">タイムライン絞り込み設定</a><div style="font-weight:bold;">ミュート設定</div><a class="menulink" href="javascript:mute(\'list\')">ID</a>&emsp;<a class="menulink" href="javascript:MenuClick(\'ngword\')">Word</a>&emsp;<a class="menulink" href="javascript:MenuClick(\'ngtitle\')">タイトル</a><div style="font-weight:bold;">その他</div><a class="menulink" href="javascript:MenuClick(\'setting\')">閲覧設定</a>&emsp;<a class="menulink" href="/test/css.html">カスタムcss</a><br><a class="menulink" href="javascript:setclear()">全ログを削除</a>&emsp;<a class="menulink" href="/test/auth.php">認証</a>';
document.getElementById('rModal').style.display = 'block';
}
